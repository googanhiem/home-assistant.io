...
The ability to trigger an on-demand automated backup is excellent, as it
covers all your backup settings in a single click. However, the ability to create manual
...
Are you a [Home Assistant Cloud by Nabu Casa] user? Then you're in for a
...
[Home Assistant Cloud account page](https://account.nabucasa.com/) found on the Nabu Casa website in case you need it. This way,
...
So, automated backups can be stored on your local disk and Home Assistant
...
This extensibility ensures you can store your backups where you want,
...
**You can read all about it in our [3...2...1... Backups blog post](/blog/2025/01/06/time-to-get-serious-about-backups/)**
...
Quite a bunch of shared "What the Heck?!" moments that have been addressed in this
